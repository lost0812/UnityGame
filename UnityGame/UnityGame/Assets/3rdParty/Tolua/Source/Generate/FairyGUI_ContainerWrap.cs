...
public class FairyGUI_ContainerWrap
{
	...
	static int set_clipSoftness(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.Container obj = (FairyGUI.Container)o;
			System.Nullable<UnityEngine.Vector4> arg0 = (System.Nullable<UnityEngine.Vector4>)ToLua.CheckObject(L, 2, typeof(System.Nullable<UnityEngine.Vector4>));
	...
	static int set_clipRect(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.Container obj = (FairyGUI.Container)o;
			System.Nullable<UnityEngine.Rect> arg0 = (System.Nullable<UnityEngine.Rect>)ToLua.CheckObject(L, 2, typeof(System.Nullable<UnityEngine.Rect>));
			obj.clipRect = arg0;
			return 0;
		}
		catch(Exception e)
